library CheatSystem initializer init requires Multiboard
	...
	private function SetCheats takes nothing returns nothing
		...
		call Cheat.create(gg_trg_CheatLowHp, "-lowhp", "Reduces the hero's health to minimum.")
		call Cheat.create(gg_trg_CheatLowMp, "-lowmp", "Reduces the hero's mana to minimum.")
