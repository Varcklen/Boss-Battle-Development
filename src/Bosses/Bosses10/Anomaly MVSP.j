scope AnomalyMVSP initializer init

	globals
		public trigger Trigger = null
		
		private constant integer EFFECT_ID = 'A0VQ'
		private constant integer BUFF_ID = 'B02G'
		private constant integer DURATION = 20
		
		private constant string SPAWN_ANIMATION = "Abilities\\Spells\\Human\\DispelMagic\\DispelMagicTarget.mdl"
		private constant string USE_ANIMATION = "Abilities\\Spells\\Human\\DispelMagic\\DispelMagicTarget.mdl"
		private constant string MODEL = "Abilities\\Spells\\NightElf\\ThornsAura\\ThornsAura.mdl"
	...
	private function UnitAffect takes unit target returns nothing
		call bufallst( target, target, EFFECT_ID, 0, 0, 0, 0, BUFF_ID, "anomaly_speed", DURATION )
