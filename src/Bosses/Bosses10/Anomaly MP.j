scope AnomalyMP initializer init

	globals
		public trigger Trigger = null
		
		private constant real MP_HEAL_PERCENT = 0.4
		
		private constant string SPAWN_ANIMATION = "Abilities\\Spells\\Items\\AIma\\AImaTarget.mdl"
		private constant string USE_ANIMATION = "Abilities\\Spells\\Items\\AIma\\AImaTarget.mdl"
		private constant string MODEL = "Abilities\\Spells\\Human\\Brilliance\\Brilliance.mdl"
		private constant real MODEL_SIZE = Wendigo1_ANOMALY_AREA_SIZE / 80.
	endglobals
	
	private function UnitAffect takes unit target returns nothing
		call manast( target, null, GetUnitState( target, UNIT_STATE_MAX_MANA) * MP_HEAL_PERCENT )
