scope AnomalyATSP initializer init

	globals
		public trigger Trigger = null
		
		private constant integer EFFECT_ID = 'A0VO'
		private constant integer BUFF_ID = 'B02F'
		...
		private constant string USE_ANIMATION = "Abilities\\Spells\\NightElf\\BattleRoar\\RoarCaster.mdl"
		private constant string MODEL = "Abilities\\Spells\\Undead\\VampiricAura\\VampiricAura.mdl"
	...
	private function UnitAffect takes unit target returns nothing
		call bufallst( target, target, EFFECT_ID, 0, 0, 0, 0, BUFF_ID, "anomaly_rage", DURATION )
