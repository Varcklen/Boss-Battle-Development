library WeaponPieceDatabase initializer init requires WeaponPieceSystem
	...
	private function SetItems takes nothing returns nothing
		...
		call WeaponPiece.create('I025', BattleHalberd_Trigger, AfterAttack, "BattleHalberd", TRIGGER_TYPE_TRIGGER_UNIT )
		...
		call WeaponPiece.create('I046', Chakrum_Trigger, AfterAttack, "Chakrum", TRIGGER_TYPE_TRIGGER_UNIT )
		...
		call WeaponPiece.create('I079', HookHands_Trigger, AfterAttack, "HookHands", TRIGGER_TYPE_TRIGGER_UNIT )
		...
		call WeaponPiece.create('I02E', OgreClub_Trigger, AfterAttack, "OgreClub", TRIGGER_TYPE_TRIGGER_UNIT )
