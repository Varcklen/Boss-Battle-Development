scope FireFlower initializer init

	globals
		private constant integer ABILITY_ID = 'A1J3'
		private constant integer HEAL = 300
		private constant integer HEALTH_GAIN = 10
		private constant string ANIMATION = "Abilities\\Spells\\Human\\Resurrect\\ResurrectTarget.mdl"
	endglobals
	...
	private function action takes nothing returns nothing
	    ...
	    loop
	        ...
	        if combat(target, false, 0) and ExtraArenaGeneral_IsPvPActive() == false then
